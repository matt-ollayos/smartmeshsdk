...
class IpMgrConnectorSerial(IpMgrConnectorSerialInternal):
    ...
    def dn_radiotestXtalComp(self, bias, spinDownMs, spinUpMs, iterations) :
        res = IpMgrConnectorSerialInternal.send(self, ['radiotestXtalComp'], {"bias" : bias, "spinDownMs" : spinDownMs, "spinUpMs" : spinUpMs, "iterations" : iterations})
        return IpMgrConnectorSerial.Tuple_dn_radiotestXtalComp(**res)
    ...
    def dn_radiotestXtal(self, trimOpt, tempGrade) :
        res = IpMgrConnectorSerialInternal.send(self, ['radiotestXtal'], {"trimOpt" : trimOpt, "tempGrade" : tempGrade})
        return IpMgrConnectorSerial.Tuple_dn_radiotestXtal(**res)
